...
# Amber's Challange #1 Answer
```{r}
ggplot(data = world) +
  geom_sf() +
  ggtitle("Countries of the World", subtitle = "Created by Amber Camp") +
  xlab("Longitude") + ylab("Latitude")
...
# Looks like iso_3 for Australia is AUS, but there are other values for surrounding islands etc.
# Let's just deal with Australia proper for now
...
ggplot() + 
  geom_sf(data = world_without_australia, 
          fill = "slategrey", color = "tomato", size = 0.25) +
  ggtitle("Countries of the World", subtitle = "without Australia")
# these colors were used in my dissertation, and they look much nicer there, i promise.
```
...
ggplot(data = world) +
  ...
  ggtitle("Honolulu, HI as the Center of the World (Orthographic Azimuthal)", subtitle = "Because it truly is the center of my world")+
  theme_void() +
